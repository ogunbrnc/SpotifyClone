...
class PlaylistViewController: UIViewController {
    ...
    @objc func didLongPress(_ gesture: UILongPressGestureRecognizer) {
        ...
        let actionSheet = UIAlertController(title: track.name, message: "Would you like to remove this from playlist?", preferredStyle: .actionSheet)
        actionSheet.addAction(UIAlertAction(title: "Cancel", style: .cancel, handler: nil))
        actionSheet.addAction(UIAlertAction(title: "Remove", style: .destructive, handler: { [weak self] _ in
            guard let strongSelf = self else {
                return
            }
            APICaller.shared.removeTrackFromPlaylist(track: track, playlist: strongSelf.playlist) { success in
                DispatchQueue.main.async {
                    if success {
