...
class FeaturePlaylistCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        creatorNameLabel.frame = CGRect(x: 3, y: contentView.height-58, width: contentView.width-6, height: 30)
        playlistNameLabel.frame = CGRect(x: 3, y: contentView.height-88, width: contentView.width-6, height: 30)
